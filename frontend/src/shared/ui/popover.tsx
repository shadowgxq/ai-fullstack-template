...
function PopoverHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex flex-col gap-[var(--space-1)] text-[var(--font-size-md)]', className)}
      {...props}
    />
  )
}
...
function PopoverTitle({ className, ...props }: React.ComponentProps<'h2'>) {
  return (
    <h2
      ...
      className={cn(
        'text-[var(--font-size-md)] leading-[var(--line-height-md)] font-semibold',
        className,
      )}
      {...props}
    />
...
function PopoverDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-[var(--font-size-md)] leading-[var(--line-height-base)] text-muted-foreground',
        className,
      )}
      {...props}
    />
