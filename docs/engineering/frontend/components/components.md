...
| 需求                                                                   | 文档                                                     |
| ---------------------------------------------------------------------- | -------------------------------------------------------- |
| 判断怎么拆组件、拆 hook 还是 utility、看案例和反例                     | `docs/engineering/frontend/components/component-splitting.md`        |
| 查看当前已落地 UI 组件统计和清单                                       | `docs/engineering/frontend/components/component-inventory.md`        |
| 查看组件 props、可控/非可控、状态表达、数据边界和 shared primitive API | `docs/engineering/frontend/standards/component-definition.md`        |
| 查看目录、文件命名、barrel export 和模块放置细则                       | `docs/engineering/frontend/standards/file-organization.md`           |
| 查看 loading、empty、error、disabled、focus 和可访问性规则             | `docs/engineering/frontend/standards/accessibility-and-ui-states.md` |
...
后续新增类型、常量、测试、story、组件私有 hook 或子组件时，继续放在同一个 `ComponentName/` 目录内。具体结构见 `docs/engineering/frontend/standards/file-organization.md`。
...
组件已经落地并稳定使用后，更新 `docs/engineering/frontend/components/component-inventory.md`：
...
- 规则变化时同步更新 `docs/engineering/frontend/README.md` 和 `docs/README.md` 的入口说明。
